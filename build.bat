...
SET WARNING_FLAGS=-W4 -WX -wd4100 -wd4101 -wd4189 -wd4996 -wd4530 -wd4201 -wd4505 -wd4098
SET COMPILER_FLAGS=-nologo -FC -MDd -Zi %WARNING_FLAGS% %INCLUDES% -Fe:Game.exe
SET LINKER_FLAGS=-debug -SUBSYSTEM:CONSOLE -LIBPATH:ext\GLFW ..\ext\GLFW\glfw3.lib opengl32.lib user32.lib gdi32.lib winmm.lib shell32.lib
